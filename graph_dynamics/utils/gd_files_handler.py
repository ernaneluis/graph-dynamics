...
def gd_folder_stats(gd_folder,vprint=False):
    """
    ...
    for macrostring in macroStrings:
        ...
        example_macro_json = json.load(open(gd_folder+this_macro_files[-1],"r"))
